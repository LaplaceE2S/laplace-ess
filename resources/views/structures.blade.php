...
<h1>Vous êtes une structure de l'ESS</h1>

<section>
    <div class="container">
        <div class="row">
            <div class="col"><h4>Les avantages pour les structures qui s'engagent dans une démarche de mutualisation :</h4>
                <ul>
        ...
        <div class="row">
            <div class="col"><h6 class="ssTitre">Bénéficier d'une mise à disposition vous permettra de :</h6>
                <ul>
                    <li>vous consacrer à votre cœur de projet</li>
                    <li>accéder à des ressources temporaires</li>
                    <li>disposer de compétences sur des temps partiels (que vous ne pourriez avoir sur un temps plein).</li>
                </ul>
            </div>
            <div class="col"><h6 class="ssTitre">Mettre à disposition un salarié vous permettra de :</h6>
                <ul>
                    <li>développer et pérenniser le modèle économique de votre structure</li>
                    <li>optimiser le management de vos ressources humaines (évolution professionnelle, etc.)</li>
                    <li>optimiser les charges de personnel</li>
                </ul>
            </div>
        </div>
    </div>
...
<section>
    <div class="container">
        <div class="row">
            <div class="col"><h4>Comment ça marche pour bénéficier du service La Place ?</h4>
            </div>
        </div>
        <div class="row">
            <div class="col"><span class="border border-warning">Inscription</span>
            ...
            <div  class="col"><span class="border border-warning">Adhésion et Abonnement</span>
            ...
            <div class="col"><span class="border border-warning">Publication</span>
            ...
            <div class="col"><span class="border border-warning">Mise en lien</span>
            ...
            <div class="col"><span class="border border-warning">Accompagnement juridique</span>
            ...
            <div class="col"><span class="border border-warning">Contribution</span>
            ...
            <div class="col"><span class="border border-warning">Contactez-nous</span>
...
<section>
    <div class="container">
        <div class="row">
            <div class="col"><h4>Comment ça marche pour mettre à disposition un-e salarié-e ?</h4>
            </div>
        </div>
        <div class="row">
            <div class="col"><span class="border border-warning">Accord préalable</span>
            ...
            <div class="col"><span class="border border-warning">Durée</span>
                <p>La durée est souple. La mission externe peut être réalisée sur tout ou partie de son temps de travail.</p>
            </div>
            <div class="col"><span class="border border-warning">Contrat de travail</span> 
            ...
            <div class="col"><span class="border border-warning">Convention collective</span> 
            ...
            <div class="col"><span class="border border-warning">Responsabilité</span> 
            ...
            <div class="col"><span class="border border-warning">Employabilité</span> 
